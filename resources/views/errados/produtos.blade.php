    ...
    <link href="{{ asset('tema/assets/demo/demo.css')}}" rel="stylesheet" />
        ...
        <div class="container bootstrap snippet">
            <div class="row">
                <div class="col-sm-10"><h1>Produto</h1></div>
            </div>
            <div class="row">
                    ...
                    <div class="tab-pane active" id="home">
                        ...
                        <form class="form" action="##" method="post" id="registrationForm">
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <label for="phone"><h4>Descrição</h4></label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <label for="phone"><h4>Fornecedor</h4></label>
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="" title="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <label for="phone"><h4>Quantidade</h4></label>
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="" title="">
                                </div>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-xs-12">
                                    <label for="phone"><h4>Código de Barras</h4></label>
                                    <input type="text" class="form-control" name="phone" id="phone" placeholder="" title="">
                                </div>
                            </div>
